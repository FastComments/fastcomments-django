...
class SSOUserMapper:
    ...
    def __init__(self, user_map=None, is_admin=None, is_moderator=None, group_ids=None, user_mapper=None):
...
class SSOManager:
    ...
    def __init__(self, mapper, api_key, enabled, mode, login_url, logout_url):
        self.mapper = mapper
